...
hadoop fs -rm -r /user/output/tmp/tmp_Job3_10M
hadoop fs -rm -r /user/output/Job3_10M
hadoop \
	...
	-output /user/output/tmp/tmp_Job3_10M \
...
hadoop \
	...
	-D stream.num.map.output.key.fields=3 \
	-D mapreduce.job.reduces=1 \
	-input /user/output/tmp/tmp_Job3_10M/part-00000 \
	-output /user/output/Job3_10M \
