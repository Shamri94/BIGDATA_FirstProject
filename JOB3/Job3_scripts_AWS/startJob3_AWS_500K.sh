...
hadoop fs -rm -r /user/output/tmp/tmp_Job3_500K
hadoop fs -rm -r /user/output/Job3_500K
hadoop \
	...
	-output /user/output/tmp/tmp_Job3_500K \
...
hadoop \
	...
	-D stream.num.map.output.key.fields=3 \
	-D mapreduce.job.reduces=1 \
	-input /user/output/tmp/tmp_Job3_500K/part-00000 \
	-output /user/output/Job3_500K \
